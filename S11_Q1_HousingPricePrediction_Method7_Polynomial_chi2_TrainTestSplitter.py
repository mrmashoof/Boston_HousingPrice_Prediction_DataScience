...
# Session  : 11
# Question : 1 (HousingPricePrediction_Method 4)
...
df.drop(columns=['NOX', 'RM', 'PTRATIO', 'CHAS'], inplace=True) # Remove features with least chi2 score
# print(df.head())
...
# print('RandomForestRegressor Test R2: ','{:.2f}'.format(r2_score(y_test,y_test_pred)))
