...
# Session  : 11
# Question : 1 (HousingPricePrediction_Method 2)

'********************************************************************************************************'
# Algorithm : Linear Regression
# Featuer Selection Method : Removing features with the correlation out of range -0.7 to 0.7
# Train and Test Method : Train_Test_Split
...
df.drop(columns=['INDUS', 'DIS', 'NOX', 'TAX'], inplace=True) # Remove features with correlation out of range -0.7 to 0.7
# print(df.head())
